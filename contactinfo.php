...
<html>
 ...
 <body   background="./practise_flappy/img/vista.jpg">
  ...
  <h1 align="center"> </h1>
    ...
    <img src="images/31.png" class="box5"><br>
   <br />
   <div class="col-md-6" style="margin:0 auto; float:none;">
    <form method="post">
     ...
     <div class="form-group">
      <img src="images/21.png" class="box5"><br>
      <input type="text" name="name" placeholder="Enter Name" class="form-control" value="<?php echo $name; ?>" />
     </div>
     <div class="form-group">
     <img src="images/23.png" class="box5"><br>
      <input type="text" name="email" class="form-control" placeholder="Enter Email" value="<?php echo $email; ?>" />
     </div>
     <div class="form-group">
      <img src="images/22.png" class="box"><br>
      <input type="text" name="age" class="form-control" placeholder="Enter Age" value="<?php echo $age; ?>" />
     </div>
     <div class="form-group">
      <img src="images/25.png" class="box5"><br>
